<?php
    ...
    function info(){
        ...
        $postjson = array(
            ...
            "DELETE one" => "JSON file with 'delete' as id of the recipe and 'username' for user who created the recipe to post.php",
            ...
            "AUTO DELETE" => "JSON file with 'ngun' for day count and 'username' to post.php",
        );
        $outjson = array(
